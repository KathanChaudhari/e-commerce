        ...
        <div className="w-full block 800px:flex items-center justify-between">
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-[#75b5c9] shadow rounded-xl px-2 py-5">
            ...
            <Link to="/admin-sellers">
              <h5 className="pt-4 pl-2 text-white opacity-60 underline">View Sellers</h5>
            </Link>
          </div>
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-[#75b5c9] shadow rounded-xl px-2 py-5">
            ...
            <Link to="/admin-orders">
              <h5 className="pt-4 pl-2 text-white opacity-60 underline">View Orders</h5>
            </Link>
          </div>
        </div>

...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section} my-8 select-none `}>
      <h2 className="text-3xl font-bold text-gray-900 mb-8">FAQ</h2>
      <div className="mx-auto space-y-4">
        {/* single Faq */}

        <div className="border-b border-white border-opacity-40 pb-4">
          <button
            className="flex flex-col items-start  w-full"
            onClick={() => toggleTab(2)}
          >
            <span className="flex justify-between w-full text-lg font-medium text-gray-900">
              What is your return policy?
              {activeTab === 2 ? (
              <svg
                className="h-6 w-6 text-[#393d3f]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              >
                ...
                />
                    ...
                    {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-start text-[#393d3f]">
        ...
        <div className="border-b border-white border-opacity-40 pb-4">
          ...
          {activeTab === 3 && (
            <div className="mt-4">
              <p className="text-base text-[#393d3f]">
